...
@section('title', 'Assessments Pending Review')
...
<div class="container-xl">
    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="col">
                <div class="page-pretitle">Review Management</div>
                <h2 class="page-title">Assessments Pending Review</h2>
            </div>
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('review-approval.pending-review') }}" method="GET" class="row g-2">
                <div class="col-md-6">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Pending Review ({{ $pendingAssessments->total() }})</h3>
        </div>
        ...
        <div class="empty">
            ...
            <p class="empty-title">No assessments pending review</p>
            <p class="empty-subtitle text-muted">
                All completed assessments have been reviewed.
            </p>
        </div>
        @else
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-list flex-nowrap">
                                <a href="{{ route('review-approval.review', $assessment) }}" class="btn btn-sm btn-primary">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M9 5h-2a2 2 0 0 0 -2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-12a2 2 0 0 0 -2 -2h-2"></path><path d="M9 3m0 2a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v0a2 2 0 0 1 -2 2h-2a2 2 0 0 1 -2 -2z"></path><path d="M9 12l2 2l4 -4"></path></svg>
                                    Review
                                </a>
