                    ...
                    <div class="card">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="industry" class="form-control @error('industry') is-invalid @enderror" 
                                           value="{{ old('industry', $company->industry) }}" placeholder="e.g., Technology, Finance, Healthcare">
                                    @error('industry')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="size" class="form-select @error('size') is-invalid @enderror" required>
                                        ...
                                        <option value="sme" {{ old('size', $company->size) == 'sme' ? 'selected' : '' }}>SME</option>
                                        <option value="enterprise" {{ old('size', $company->size) == 'enterprise' ? 'selected' : '' }}>Enterprise</option>
                                    </select>
                                    @error('size')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="established_year" class="form-control @error('established_year') is-invalid @enderror" 
                                           value="{{ old('established_year', $company->established_year) }}" min="1900" max="{{ date('Y') }}">
                        ...
                        <div class="card-footer text-end">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ti ti-check me-2"></i>Update Company
                            </button>
                        </div>
                    </div>
                </form>
